...
type DBInterface interface {
	...
	GetThreadrelsByStakeholderIter(stakeholder, iter string) (map[int64](*taps.Threadrel), error)
	GetThreadrelsByParentIter(parent int64, iter string) (map[int64](*taps.Threadrel), error)
